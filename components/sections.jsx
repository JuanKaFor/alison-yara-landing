    ...
    <nav className={`ay-nav ${scrolled ? "is-scrolled" : ""}`}>
      ...
      <div className="ay-nav__mobile" onClick={() => setOpen(false)}>
        ...
        <a key={href} href={href}>{label}</a>
          ...
          <a href={WA_LINK} target="_blank" rel="noopener" className="ay-btn">Agendar por WhatsApp</a>
        </div>
      }
    </nav>);
...
<section className="ay-cta-final">
    <div className="ay-container">
      <div className="ay-cta-final__inner">
        ...
        <p>
          Agenda tu valoración inicial. Te respondemos en menos de 2 horas
          en horario hábil.
        </p>
        <div className="ay-cta-final__buttons">
          ...
          <a href={IG_LINK} target="_blank" rel="noopener" className="ay-btn ay-btn--outline-light">
            DM en Instagram
          </a>
        </div>
      </div>
